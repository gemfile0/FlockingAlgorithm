...
public class Corn : MonoBehaviour
{
    ...
    void Start()
    {
        Mesh meshCreated = Create(subdivisions, radius, height);
        GetComponent<MeshFilter>().sharedMesh = meshCreated;
        GetComponentInParent<MeshCollider>().sharedMesh = meshCreated;
    }
